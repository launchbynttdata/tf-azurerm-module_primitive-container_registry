...
| <a name="input_enable_identity"></a> [enable\_identity](#input\_enable\_identity) | Whether to create a SystemAssigned managed identity. Set to true to preserve identity for existing registries, or false to import an existing registry without identity management. | `bool` | `true` | no |
