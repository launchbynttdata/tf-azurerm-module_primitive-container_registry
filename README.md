...
| <a name="input_retention_policy_in_days"></a> [retention\_policy\_in\_days](#input\_retention\_policy\_in\_days) | Retention policy in days for untagged manifests. If null, this is derived from retention\_policy for backward compatibility. | `number` | `null` | no |
