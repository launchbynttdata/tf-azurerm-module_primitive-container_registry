...
| <a name="input_enable_identity"></a> [enable\_identity](#input\_enable\_identity) | Whether to configure a managed identity on the container registry. Defaults to false. | `bool` | `false` | no |
